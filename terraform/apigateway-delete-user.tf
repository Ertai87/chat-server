...
resource "aws_api_gateway_method_response" "delete_user_response_400" {
  rest_api_id = aws_api_gateway_rest_api.delete_user_api.id
  resource_id = aws_api_gateway_resource.delete_user_publish_resource.id
  http_method = aws_api_gateway_method.delete_user_publish_method.http_method
  status_code = "400"
...
resource "aws_api_gateway_method_response" "delete_user_response_500" {
  rest_api_id = aws_api_gateway_rest_api.delete_user_api.id
  resource_id = aws_api_gateway_resource.delete_user_publish_resource.id
  http_method = aws_api_gateway_method.delete_user_publish_method.http_method
  status_code = "500"
...
resource "aws_api_gateway_method_response" "delete_user_response_504" {
  rest_api_id = aws_api_gateway_rest_api.delete_user_api.id
  resource_id = aws_api_gateway_resource.delete_user_publish_resource.id
  http_method = aws_api_gateway_method.delete_user_publish_method.http_method
  status_code = "504"
...
resource "aws_api_gateway_integration_response" "delete_user_integration_response_400" {
  rest_api_id = aws_api_gateway_rest_api.delete_user_api.id
  resource_id = aws_api_gateway_resource.delete_user_publish_resource.id
  http_method = aws_api_gateway_method.delete_user_publish_method.http_method
  status_code = aws_api_gateway_method_response.delete_user_response_400.status_code
...
resource "aws_api_gateway_integration_response" "delete_user_integration_response_500" {
  rest_api_id = aws_api_gateway_rest_api.delete_user_api.id
  resource_id = aws_api_gateway_resource.delete_user_publish_resource.id
  http_method = aws_api_gateway_method.delete_user_publish_method.http_method
  status_code = aws_api_gateway_method_response.delete_user_response_500.status_code
...
resource "aws_api_gateway_integration_response" "delete_user_integration_response_timeout" {
  rest_api_id = aws_api_gateway_rest_api.delete_user_api.id
  resource_id = aws_api_gateway_resource.delete_user_publish_resource.id
  http_method = aws_api_gateway_method.delete_user_publish_method.http_method
  status_code = aws_api_gateway_method_response.delete_user_response_504.status_code
